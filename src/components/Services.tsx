...
export function Services() {
    const services = [
        ...
        {
            title: "Mobile",
            description: "Desenvolvimento de aplicativos com React Native para Android e iOS.",
            ...
            <div className="mt-6 flex flex-col gap-2 md:flex-row">
                {
                    services.map((service, index) => (
                        <div className="basis-1/3 rounded-lg bg-blue-700 p-4 text-white" key={`service-${// biome-ignore lint/suspicious/noArrayIndexKey: <explanation>
index}`}>
