                ...
                <figure>
                    ...
                    <blockquote className="mb-6">
                        <p className="text-2xl text-gray-900">
                            Patrick atendeu todas as minhas expectativas referentes ao projeto, tanto em relação ao prazo como em usabilidade e design.
                        </p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center gap-2">
                        ...
                        <div className="flex items-center divide-x-2 divide-gray-200">
                            <div className="pr-3 font-medium text-gray-900">O. C.</div>
